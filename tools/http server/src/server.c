...
/* TODO:
**   - make logging system (server.log, clients.log)
**   - OPT: make a linked list of clients (https://www.learn-c.org/en/Linked_lists)
...
int main() {
    ...
    while (1) {
        ...
        listen_goto:
        if (listen(sock, SOMAXCONN) == SOCKET_ERROR) { print_errorN("listen()"); goto cleanup_goto; }
